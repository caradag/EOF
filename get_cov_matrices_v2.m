function results = get_cov_matrices_v2(datatype, yearstart, yearend,...
...
% v2 can operate on temperature data as well and is running on 
% 'data 2014 v3.mat'
%
...
if nargin < 8 || isempty(max_nan);
    max_nan = 10; 
end

if nargin < 9 || isempty(max_succ_nan);
    max_succ_nan = 3; 
end

if nargin < 10 || isempty(interp_meth);
    interp_meth = 'spline';
end

if nargin < 11 || isempty(normalize);
    normalize = false;
end

load('data 2014 v3.mat');
...
for kk=1:N2
    ...
    for jj=1:N1;
        ...
        if strcmp(datatype,'pressure');
            ...
            save(filename,'cov_clean','temp_mean','sensors_clean',...
            'start_time','end_time');
        end
